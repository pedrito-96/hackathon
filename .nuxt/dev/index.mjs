...
const _lazy_iKSCiF = () => Promise.resolve().then(function () { return chat_post$1; });
const _lazy_5rmMFB = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/chat', handler: _lazy_iKSCiF, lazy: true, middleware: false, method: "post" },
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Hackathon 2024"};
